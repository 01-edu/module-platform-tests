...
You must follow the same [instructions](../ascii-art/README.md) as in the first subject but this time the process will be reversed. desrever fo dnik siht toN.
